            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <div>
                ...
                <input
                  type="file"
                  name="file"
                  className="w-full cursor-pointer rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-zinc-300 outline-none file:mr-4 file:rounded-full file:border-0 file:bg-emerald-400 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-black hover:border-white/20 focus:border-emerald-300"
                />
                <p className="mt-2 text-xs text-zinc-500">
                  Optional: attach a screenshot, document, or file to help us resolve the issue faster.
                </p>
              </div>
